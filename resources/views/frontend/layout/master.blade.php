                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    @if(Auth::guard('web')->check())
                        <div class="d-flex align-items-center">
                            <img class="user-avatar-small border" src="{{ Auth::guard('web')->user()->avatar ?? asset('assets/frontend/img/no-avatar.png') }}" alt="avatar">
...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p class="mb-2">
                <i class="fa fa-map-marker-alt text-primary mr-3"></i>Số 16, ngõ 506 Kim Giang, phường Thịnh Liệt, quận Thanh Trì, Hà Nội
            </p>
            <p class="mb-2">
                <i class="fa fa-envelope text-primary mr-3"></i>hthu1972003@gmail.com
            </p>
            <p class="mb-0">
                <i class="fa fa-phone-alt text-primary mr-3"></i>0915 00 66 55
            </p>
        </div>
